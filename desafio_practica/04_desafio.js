...
// Crea una variable llamada "nombre" y asígnale tu nombre. Luego, utiliza alert para mostrar el mensaje 
// "¡Hola, [tu nombre]!".
...
// ¿Cuál es el lenguaje de programación que más te gusta?. Luego, almacena la respuesta en una variable 
...
// Luego, realiza la suma de estos dos valores y almacena el resultado en una tercera variable llamada "resultado". Utiliza console.log para mostrar el mensaje 
...
// Crea una variable llamada "valor1" y otra llamada "valor2", asignándoles valores numéricos de tu elección. 
// Luego, realiza la resta de estos dos valores y almacena el resultado en una tercera variable llamada "resultado". Utiliza console.log para mostrar el mensaje 
// "La diferencia entre [valor1] y [valor2] es igual a [resultado]." en la consola.

let val1 = 9;
let val2 = 3;
let res = val1 - val2;
console.log(`La diferencia entre ${val1} y ${val2} es igual a ${res}.`);
...
let number = prompt("Coloca un número");
if (number > 0) {
